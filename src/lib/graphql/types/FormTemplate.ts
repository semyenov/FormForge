...
const FormTemplateFieldType = builder.drizzleNode('formTemplateFields', {
  name: 'FormTemplateField',
  id: { column: (formTemplateField) => formTemplateField.id },
  fields: (t) => ({
...
const FormTemplateType = builder.drizzleNode('formTemplates', {
  name: 'FormTemplate',
  id: { column: (formTemplate) => formTemplate.id },
  fields: (t) => ({
    name: t.exposeString('name'),
